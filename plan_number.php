...
<p> </p> 
<p> </p>
 <form action="plan_details.php" method="post" name="number" onSubmit="return validate(this)">
...
<h3>Enter Lesson plan Number and submit</h4>
  		<table border="0">
        	<tr>
            	
            
          	<tr>
            	<td><h4> Lesson Plan Number:</h4></td>
